...
import {
  BarChart2, CreditCard, History, DollarSign,
  UserCheck, FileCheck, ClipboardList, User,
  Menu, ChevronDown, ChevronRight,
  Settings, ClipboardList as ClipboardListIcon,
} from 'lucide-react'
...
export default function Sidebar({ role }: SidebarProps) {
  ...
  // Render menu sesuai role, lebih aman
          ...
          <div>
            ...
            <div className="space-y-1">
              <MenuSection title="Employee" menuId="employee" icon={User}>
                ...
                <NavItem href="/employee/claims" icon={ClipboardListIcon} isActive={pathname === '/employee/claims'}>
                  Claims
                </NavItem>
